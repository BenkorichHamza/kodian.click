    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('nameAr')->formatStateUsing(fn (?Product $record): string => $record?->nameAr ?? $record?->name ?? ''),
                Forms\Components\TextInput::make('description')->formatStateUsing(fn (?Product $record): string => $record?->description ?? $record?->name ?? ''),
                Forms\Components\TextInput::make('descriptionAr')->formatStateUsing(fn (?Product $record): string =>$record?->descriptionAr ?? $record?->descriptionAr ?? $record?->name ?? ''),
                Forms\Components\TextInput::make('barcode'),
                Forms\Components\TextInput::make('code')->default(fn (?Product $record): string => $record?->code ??$record?->barcode ?? ''),
