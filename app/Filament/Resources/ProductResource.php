    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('nameAr')->default(fn (?Product $record): string => $record?->name ?? ''),
                Forms\Components\TextInput::make('descriptionAr')->default(fn (?Product $record): string => $record?->name ?? ''),
                Forms\Components\TextInput::make('description')->default(fn (?Product $record): string => $record?->name ?? ''),
                Forms\Components\TextInput::make('code')->default(fn (?Product $record): string => $record?->code ?? ''),
